...
The most basic partition plot just provides a barplot of raw region counts. You can produce one or two-set plots like so:
...
You can do this with more than one regionset:
