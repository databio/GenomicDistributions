...
Genomic partition distribution plots show you how your regions are distributed by raw numbers, relative to the expected distribution, and the cumulative distribution among promoters, exons, introns, or intergenic regions. For the raw partition distribution and the expected partition distribution you can produce one or two-set plots like so:
...
For the cumulative distribution plot, it doesn't make sense to plot multiple samples on the same plot
# TODO: look at the feature dist plots, they plot using facets...
