...
gp3 = calcPartitionsRef(queryList, "hg19", bpProportion=T)
plotPartitions(gp3)
```
...
ep3 = calcExpectedPartitionsRef(queryList, "hg19", bpProportion=T)
