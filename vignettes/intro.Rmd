...
*Dinucleotide frequency plots* display the density of each dinucleotide over the genomic ranges in a GRanges query as a violin plot
...
```{r dinic-content-plots-multi, fig.cap="Multiple finucleotide frequency plots.", eval=FALSE}
