...
If you have a set of genomic ranges, the GenomicDistributions R package can help you with some simple visualizations. Currently, it can produce three kinds of plots:
...
gp2 = genomicPartitions(GRangesList(query, query2), "hg19")
partitionPlot(gp2)
```
