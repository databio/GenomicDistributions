...
frifPlot = plotFRiF(dists)
```

## Cell specific open chromatin signal plots
...
## GC content plots 
*GC content plots* will return a probability density function of GC content percentage over the genomic ranges in the query. 

```{r GC content plots, fig.cap="GC content plot. Probability density function of GC percentage"}
...
```{r multiple distributions in one}
