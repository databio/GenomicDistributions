...
p = plotFeatureDist(TSSdist, featureName="TSS", tile=TRUE, nbin=200, labelOrder = "center")
print(p)
```
...
gr1 = GenomicRanges::sort(GenomicRanges::sortSeqlevels(
...
![plot of chunk partition-plot2](figures-full-power/partition-plot-2.png)
...
![plot of chunk expected-partition-plot2](figures-full-power/expected-partition-plot-2.png)
...
![plot of chunk cumulative-partitions2](figures-full-power/cumulative-partitions-2.png)
