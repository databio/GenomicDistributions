...
#'     specifying which columns to aggregate, and which functions to 
#'     use. You can use buildJ() to build a jExpr argument easily.
#' @param byRegionGroup You can aggregate by regionID or by regionGroupID; 
#'     this reflects the regionsGRL that you pass; by default, 
#'     BSAggregate will aggregate each region individually -- 
#'     scores will then be contiguous, and the output is 1 row per region.
